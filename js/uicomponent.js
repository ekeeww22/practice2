...
UIComponent.Modal = function(prop){
	...
	this.open = function(){
		...
		_target.dispatchEvent(UIComponent.Event.popupOpen,{"item":this});
	}
	...
	this.close = function(){
		...
		_target.dispatchEvent(UIComponent.Event.popupClose,{"item":this});
	}
...
UIComponent.Toast.Message = function(message,option){
    ...
    function setTimeoutfn(){
        setTimeout(function(){
            if(_el != null && _el.classList != null) _el.classList.add('show');  
        },100);

        setTimeout(function(){
            if(_el != null && _el.classList != null) _el.classList.remove('show'); 
            if(_el != null && _el.classList != null) _el.classList.add('hide');  
        },4000);
